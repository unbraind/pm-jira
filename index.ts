 ...
 */
export function optionsOrEmpty(
  options: Record<string, unknown> | undefined | null | false | "" | 0,
...
export function setPmSdkImporter(
  ...
  importPmSdk = importer
    ? () => importer() as ReturnType<typeof defaultImportPmSdk>
    : defaultImportPmSdk;
...
export async function resolveCommitItemMutations(
  ...
  let mod: Awaited<ReturnType<typeof defaultImportPmSdk>>;
  try {
...
export async function importJiraAtomic(
  ...
  let sdkHelpers: Awaited<ReturnType<typeof defaultImportPmSdk>> | undefined;
  const getSdk = async (): Promise<Awaited<ReturnType<typeof defaultImportPmSdk>>> => {
 ...
 */
export function handlePushOnWrite(
  hookCtx: { path?: string; scope?: string; op?: string } | undefined,
  envLike: NodeJS.ProcessEnv = process.env,
  diagnose: typeof diagnoseCreds = diagnoseCreds,
): void {
